...
<head>
    ...
    <link href="{{asset('public/frontend/assetscss/prettyPhoto.css')}}" rel="stylesheet">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ ('public/frontend/assetsimages/ico/apple-touch-icon-144-precomposed.png')}}">
