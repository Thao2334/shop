                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cate_post_name"class="form-control" onkeyup="ChangeToSlug();" id="
                            slug" placeholder="Tên sản phẩm">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slug</label>
                            <input type="text" name="cate_post_slug"class="form-control" id="
                            convert_slug" placeholder="Tên sản phẩm">
                        </div>
                        <div class="form-group">
