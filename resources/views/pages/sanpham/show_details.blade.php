...
<head>
    ...
    <link href="{{ asset('public/frontend/assets/css/prettyPhoto.css')}}" rel="stylesheet">
    <link href="{{ asset('public/frontend/assets/css/price-range.css')}}" rel="stylesheet">
    <link href="{{ asset('public/frontend/assets/css/animate.css')}}" rel="stylesheet">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{('public/frontend/assets/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{('public/frontend/assets/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{('public/frontend/assets/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{('public/frontend/assets/images/ico/apple-touch-icon-57-precomposed.png')}}">
</head><!--/head-->
...
<body>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								><a href="#companyprofile" data-toggle="tab">Chi tiết sản phẩm</a></li>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<ul>
										...
										<li><a href=""><i class="fa fa-calendar-o"></i>16.11 2022</a></li>
									</ul>
									<style type="text/css">
									.style_comment {
    ...
    <script src="{{ asset('public/frontend/assets/s/jquery.js') }}"></script>
